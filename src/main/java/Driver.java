...
public class Driver {
    public static void main(String[] args) {
        ...
        expenseManager.addUser(new User("u1", "User1"));
        expenseManager.addUser(new User("u2", "User2"));
        expenseManager.addUser(new User("u3", "User3"));
        expenseManager.addUser(new User("u4", "User4"));
